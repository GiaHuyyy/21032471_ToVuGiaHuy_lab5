  ...
  return (
    <View style={{ padding: 20 }}>
      ...
      <View style={{ alignItems: "center", marginBottom: 40 }}>
        <Image source={require("../assets/Data/Image 19.png")} style={{ width: 100, height: 100 }} />
      ...
      <View>
        ...
        >
          ...
          <TextInput placeholder="Enter your username" style={{ flex: 1 }} value={user} onChangeText={setUser} />
        </View>
        <View
          style={{
            flexDirection: "row",
